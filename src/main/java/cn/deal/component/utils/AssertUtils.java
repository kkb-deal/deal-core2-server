...
public class AssertUtils {
	...
	protected static final String PARAM_ERROR_CODE = "param_error";

	public static void notEmpty(String value, String msg) {
		if (StringUtils.isEmpty(value)) {
			throw new BusinessException(PARAM_ERROR_CODE, msg); 
		}
	}
	 ...
	 * @param msg
	 */
	public static void notAllBlank(List<String> css, String msg) {
		boolean flag = false;
		
		for (CharSequence sequence : css) {
	...
	public static void notAllNullAndEmpty(String object,String objectSec,String message) {
		if (org.apache.commons.lang3.StringUtils.isEmpty(object) && org.apache.commons.lang3.StringUtils.isEmpty(objectSec)) {
			throw new IllegalArgumentException(message);
		}
	}
	 ...
	 * @see org.apache.commons.lang3.StringUtils#hasLength
	 */
	 ...
	 * @param message
	 *            the exception message to use if the assertion fails
	 * @see org.apache.commons.lang3.StringUtils#hasText
	 */
